...
namespace API.Helpers
{
    ...
    public class ManagementHelper{
        ...
        public string GetManagementToken(IConfiguration configuration){
            ...
            request.AddBody(new{
                client_id ="kUAAhoahZIBdb6SMoQZbryn9fZ6WIbsy",
                client_secret="zTHQ3l3jxD_coV1WO5xJGe1GyXOdZfwapI54k-EPLc3l4NuuyHAvm9c1UpwlObhN",
                audience="https://dev-tt6-hw09.us.auth0.com/api/v2/",
